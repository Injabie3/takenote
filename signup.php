...
if(empty($_POST["userid"])){
    ...
    $username = filter_var($_POST["userid"], FILTER_SANITIZE_STRING);   
}
//Get email
...
if(empty($_POST["password"])){
    ...
    if(empty($_POST["reenterpassword"])){
        ...
        $password2 = filter_var($_POST["reenterpassword"], FILTER_SANITIZE_STRING);
...
$message .= "http://notetaking.injabie3.moe/activate.php?email=" . urlencode($email) . "&key=$activationKey";

if(mail($email, 'Confirm your Registration', $message, 'From:'.'testEmail@gmail.com')){
